...
public class BDVSourceListManagerItem extends JPanel implements ListCellRenderer {
	 ...
	 * Create the panel.
	 */
	public BDVSourceListManagerItem(BigDataViewer bdv) {
	...
	protected void setSource(final BigDataViewer bdv, SourceState<?> source, final int idx)
	{
	...
	public Component getListCellRendererComponent(JList list,
		...
		*/
		...
		// check if this cell is selected
			...
			if (bdv.getViewer().getState().getCurrentSource() != index)
			{
				final VisibilityAndGrouping vg = bdv.getViewer().getVisibilityAndGrouping();
