package de.mpicbg.rhaase.bdvtools.plugins.dataprobe;
																				...
																				MouseMotionListener
{
	...
	@Override public void run()
	{
		...
		if (!toolButton.isSelected()) {
			...
			bdv.getViewer().getDisplay().addMouseMotionListener(this);
			...
			bdv.getViewer().getDisplay().removeMouseMotionListener(this);
	...
	public void mouseMoved(MouseEvent e) {
		...
		bdv.getViewer().getGlobalMouseCoordinates(gPos);
